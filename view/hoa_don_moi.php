...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="admin.php">Danh sách</a></li>
            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="admin.php?task=detailorder&id=<?php echo $hd['id'] ?>" class="btn btn-primary">Xem
                                chi tiết</a>
                            <?php if($hd['active']==0){ ?>
                            <a onclick="return confirm('Bạn có chắc chắn muốn duyệt đơn hàng này?')"
                                href="admin.php?task=activeorder&id=<?php echo $hd['id'] ?>"
                                class="btn btn-warning">Duyệt đơn</a>
                            <?php } ?>
                        </td>
                    </tr>
                    <?php }} ?>
