        ...
        <div class="panel">
            <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo $this->model->get('products','id='.$sp['product_id'])['sale_price'] ?>đ
                                    </td>
                ...
                <div class="text-right no-print">
                    ...
                    <a onclick="return confirm('Bạn có chắc chắn muốn duyệt đơn hàng này?')"
                        href="admin.php?task=activeorder&id=<?php echo $order['id'] ?>" class="btn btn-success">Duyệt
                        đơn</a>
                    <?php } ?>
                    <a href="admin.php?task=deleteorder&id=<?php echo $order['id'] ?>"
                        onclick="return confirm('Bạn có chắc chắn muốn hủy đơn?')" class="btn btn-danger">Hủy đơn</a>
                </div>
