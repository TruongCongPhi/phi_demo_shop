            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    if (is_null($order_list)) {
                        echo '<tr><td>Chưa có hóa đơn nào !</td></tr>';
                    } else {
                        while ($hd = $order_list->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($hd['active'] == 0) echo '<span class="btn btn-danger">Chưa duyệt</span>';
                                    if ($hd['active'] == 1) echo '<span class="btn btn-success">Đã duyệt</span>';  ?>
                                </td>
                                <td>
                                    <a href="admin.php?task=detailorder&id=<?php echo $hd['id'] ?>" class="btn btn-success">Xem
                                        đơn</a>
                                    <a href="admin.php?task=deleteorder&id=<?php echo $hd['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger">Xóa</a>
                                </td>
                            </tr>
                    <?php }
                    } ?>
